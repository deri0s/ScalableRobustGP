...
Distributed computations were implemented using the Generalised Product of GPs detailed in the following paper.


# Example using synthetic data

The data used in this example was generated by 3 independent sources of noise.
