...
# Assign lags to the training data
...
ax.plot(date_time, mus, color="blue", linewidth = 2.5, label="Cleaned")
ax.plot(date_time, mu, color="red", linewidth = 2.5, label="Extrapolate")
...
# PCA on clean data
X0_train = X_train[sgp.indices[0], :]
...
if sgp.K_opt != 1:
    for i, (k, c) in enumerate(zip(enumerate_K, color_iter)):
        ax.plot(date_time[sgp.indices[k]], y_raw[sgp.indices[k]],
