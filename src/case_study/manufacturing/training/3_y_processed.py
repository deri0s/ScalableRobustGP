...
file_name = 'clean1.xlsx'
file = PROCESSED_PATH / file_name
...
if len(known_indices) < 2:
    ...
    # 'linear' is common, 'cubic' or 'quadratic' can be smoother if appropriate for your data
    interp_func = interp1d(known_time, known_values, kind='quadratic',
...
# y_test_df = pd.DataFrame(y.append(middle))
# clean2 = pd.concat([X_test_df, y_test_df], axis=1)
# print('\n what is clean2: ', type(clean2))

# clean2.to_csv(f"{PROCESSED_PATH}/clean2.csv", index=False)